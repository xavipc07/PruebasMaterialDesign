...
public class OpcionesTransicion extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.opciones_transicion);
        ...
        switch (v.getId()) {
            ...
            case R.id.explodeJava: {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    Intent i = new Intent(OpcionesTransicion.this, TransitionActivity.class);
            ...
            case R.id.shared_element: {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    Intent i = new Intent(OpcionesTransicion.this, SharedElementActivity.class);
                    startActivity(i, options.toBundle());
